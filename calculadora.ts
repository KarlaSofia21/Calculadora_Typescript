window.addEventListener('DOMContentLoaded', (event) => {
    ...
    function calculate(operacion: string): void {
      const valor1 = parseFloat((<HTMLInputElement>document.getElementById("valor1")).value);
      const valor2 = parseFloat((<HTMLInputElement>document.getElementById("valor2")).value);
